...
import { Cell, CellDescription, CellRight, CellTitle, RowTable, Table, TableInfo, TitleTable, TablesContainer, TableContainer, TotalPrice } from './review-order-styles';
...
const productsShopping = [
    {
        ...
        color: "NEGRO",
        currency: "€",
        detail: "Camiseta de cuello redondo y manga corta. Estampación combinada a contraste en delantero.",
...
const getTotalPrice = () => productsShopping.map(product => product.price).reduce((accum, p) => {
